!(function (e, t) {
  ...
  class e {
    constructor(e) {
      e || (e = {}),
        (this.main = e.main || "ss-main"),
        (this.placeholder = e.placeholder || "ss-placeholder"),
        (this.values = e.values || "ss-values"),
        (this.single = e.single || "ss-single"),
        (this.max = e.max || "ss-max"),
        (this.value = e.value || "ss-value"),
        (this.valueText = e.valueText || "ss-value-text"),
        (this.valueDelete = e.valueDelete || "ss-value-delete"),
        (this.valueOut = e.valueOut || "ss-value-out"),
        (this.deselect = e.deselect || "ss-deselect"),
        (this.deselectPath = e.deselectPath || "M10,10 L90,90 M10,90 L90,10"),
        (this.arrow = e.arrow || "ss-arrow"),
        (this.arrowClose = e.arrowClose || "M10,30 L50,70 L90,30"),
        (this.arrowOpen = e.arrowOpen || "M10,70 L50,30 L90,70"),
        (this.content = e.content || "ss-content"),
        (this.openAbove = e.openAbove || "ss-open-above"),
        (this.openBelow = e.openBelow || "ss-open-below"),
        (this.search = e.search || "ss-search"),
        (this.searchHighlighter = e.searchHighlighter || "ss-search-highlight"),
        (this.searching = e.searching || "ss-searching"),
        (this.addable = e.addable || "ss-addable"),
        (this.addablePath = e.addablePath || "M50,10 L50,90 M10,50 L90,50"),
        (this.list = e.list || "ss-list"),
        (this.optgroup = e.optgroup || "ss-optgroup"),
        (this.optgroupLabel = e.optgroupLabel || "ss-optgroup-label"),
        (this.optgroupLabelText =
          e.optgroupLabelText || "ss-optgroup-label-text"),
        (this.optgroupActions = e.optgroupActions || "ss-optgroup-actions"),
        (this.optgroupSelectAll = e.optgroupSelectAll || "ss-selectall"),
        (this.optgroupSelectAllBox =
          e.optgroupSelectAllBox || "M60,10 L10,10 L10,90 L90,90 L90,50"),
        (this.optgroupSelectAllCheck =
          e.optgroupSelectAllCheck || "M30,45 L50,70 L90,10"),
        (this.optgroupClosable = e.optgroupClosable || "ss-closable"),
        (this.option = e.option || "ss-option"),
        (this.optionDelete = e.optionDelete || "M10,10 L90,90 M10,90 L90,10"),
        (this.highlighted = e.highlighted || "ss-highlighted"),
        (this.open = e.open || "ss-open"),
        (this.close = e.close || "ss-close"),
        (this.selected = e.selected || "ss-selected"),
        (this.error = e.error || "ss-error"),
        (this.disabled = e.disabled || "ss-disabled"),
  ...
  class l {
        ...
        if (o instanceof n)
          for (let n of o.options)
            s || (s = n),
              ...
              n.selected &&
                (l.push(n), "single" === this.selectType && (i = !0));
        o instanceof a &&
          (s || (s = o),
          (o.selected = !i && t.includes(o[e])),
          o.selected && (l.push(o), "single" === this.selectType && (i = !0)));
      }
      "single" === this.selectType && s && !i && ((s.selected = !0), l.push(s));
      const o = t.map((t) => {
        var s;
        return (
          (null === (s = l.find((s) => s[e] === t)) || void 0 === s
            ? void 0
            : s.id) || ""
        );
      });
    ...
    getFirstOption() {
      ...
      for (let t of this.data)
        if (
          (t instanceof n ? (e = t.options[0]) : t instanceof a && (e = t), e)
        )
          break;
      return e;
    }
    ...
    searchDiv() {
      ...
      if (
        (this.settings.showSearch ||
          (e.classList.add(this.classes.hide), (t.readOnly = !0)),
        (t.type = "search"),
    ...
    renderOptions(e) {
      if (((this.content.list.innerHTML = ""), 0 === e.length)) {
        ...
        return (
          e.classList.add(this.classes.search),
          this.callbacks.addable
            ? (e.innerHTML = this.settings.addableText.replace(
                "{value}",
      ...
      if (this.settings.allowDeselect && !this.settings.isMultiple) {
        this.store.filter((e) => e.placeholder, !1).length ||
          this.store.addOption(
            new a({ text: "", value: "", selected: !1, placeholder: !0 }),
            !0
          );
      }
      for (const t of e) {
      ...
      for (const n of e) {
        if (
          ...
          for (const e of n.addedNodes)
            if ("OPTION" === e.nodeName && e.value === this.select.value) {
              this.select.dispatchEvent(new Event("change"));
              break;
            }
          i = !0;
        }
        ("OPTGROUP" !== n.target.nodeName && "OPTION" !== n.target.nodeName) ||
          (i = !0);
      }
      t &&
        this.onClassChange &&
  ...
  class c {
    constructor(e) {
      (this.id = ""),
        ...
        (this.focusSearch = void 0 === e.focusSearch || e.focusSearch),
        ...
        (this.keepOrder = void 0 !== e.keepOrder && e.keepOrder),
  ...
  return class {
    constructor(t) {
      ...
      this.selectEl.dataset.ssid && this.destroy(),
        (this.settings = new c(t.settings)),
        (this.cssClasses = new e(t.cssClasses));
      const n = [
        "afterChange",
        "beforeOpen",
        "afterOpen",
      ...
      for (const e in t.events)
        t.events.hasOwnProperty(e) &&
          (-1 !== n.indexOf(e)
            ? (this.events[e] = s(t.events[e], 100))
            : (this.events[e] = t.events[e]));
      (this.settings.disabled = (
        null === (i = t.settings) || void 0 === i ? void 0 : i.disabled
      )
        ? t.settings.disabled
        ...
        (this.select = new h(this.selectEl)),
      ...
      (this.render = new o(this.settings, this.cssClasses, this.store, a)),
        this.render.renderValues(),
        this.render.renderOptions(this.store.getData());
      const r = this.selectEl.getAttribute("aria-label"),
        d = this.selectEl.getAttribute("aria-labelledby");
      r
        ? this.render.main.main.setAttribute("aria-label", r)
        : d && this.render.main.main.setAttribute("aria-labelledby", d),
    ...
    setSelected(e, t = !0) {
      ...
      const a = [];
      for (const t of e)
        if (n.find((e) => e.id == t)) a.push(t);
        else for (const e of n.filter((e) => e.value == t)) a.push(e.id);
      this.store.setSelectedBy("id", a);
      const l = this.store.getData();
      this.select.updateOptions(l),
        this.render.renderValues(),
        "" !== this.render.content.search.input.value
          ? this.search(this.render.content.search.input.value)
          : this.render.renderOptions(l),
        t &&
          this.events.afterChange &&
          !i(s, this.store.getSelected()) &&
          this.events.afterChange(this.store.getSelectedOptions());
    }
    addOption(e) {
      const t = this.store.getSelected();
